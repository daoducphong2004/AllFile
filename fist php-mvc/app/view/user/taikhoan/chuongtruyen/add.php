        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="<?= ROOT_PATH ?>admin/addcategory" enctype="multipart/form-data">
                        <div class="form-group clearfix required">
                            <label class="col-md-2 control-label pt-7 text-right">Tên Truyện</label>
                            <div class="col-md-8">
                                <select class="form-control"name="MaTruyen" id="">
                        ...
                        <div class="form-group clearfix required">
                            ...
                            <div class="col-md-8">
                                 <select class="form-control" name="TenDanhMuc" id=" ">
                                <option value="">Chọn</option>
