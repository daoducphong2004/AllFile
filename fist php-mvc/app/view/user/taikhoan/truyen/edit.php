            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?= ROOT_PATH ?>action/edittruyen" enctype="multipart/form-data">
                            <input type="hidden" name="MaNguoiDang" value='<?=json_decode($_COOKIE['TaiKhoan'])->MaNguoiDung;?>'>
