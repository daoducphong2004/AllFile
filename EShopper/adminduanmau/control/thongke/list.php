<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Số đơn hàng </h4>
                    <div class="dropdown">
                        <button onclick="myFunction()" class="dropbtn">Năm</button>
                        <div id="myDropdown" class="dropdown-content">
                            <a href="index.php?act=listtk&year=2021">2021</a>
                            <a href="index.php?act=listtk&year=2022">2022</a>
                            <a href="index.php?act=listtk&year=2023">2023</a>
                            <a href="index.php?act=listtk&year=2024">2024</a>
                        </div>
                        <?php 
                      if(isset($_GET['year'])){
                        ...
                        <table class="table user-table no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-top-0">Số Đơn</th>
                                    <th class="border-top-0">Tổng doanh thu</th>
                                    <th class="border-top-0">Số đơn hoàn thành</th>
                                    <th class="border-top-0">Doanh thu thực</th>
                                    <th class="border-top-0">Số đơn bị huỷ</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                <tr>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $key['donhang'] ?></td>
                                    <td><?php echo $key['doanhthu'] ?></td>
                                    <td><?php echo $key['donthanhcong'] ?></td>
                                    <td><?php echo $key['doanhthuthuc'] ?></td>
                                    <td><?php echo $key['donhuy'] ?></td>
                                </tr>
                                <?php 
                                endforeach;
                                endfor ?>
